...
BASE_FOLDER = "/Users/Zander/Desktop/Italy"
RESOURCE_FOLDER = BASE_FOLDER + "Website"
...
def main():
    ...
    matches = (
        ...
        [file.split('.')[0] for file in glob.glob("*.png")]
    )
    ...
    output_file = os.path.join(BASE_FOLDER + ".html")
