...
TEMPLATE = "status_jinja.html"
#the Directory it will use to generate
BASE_FOLDER = "/Users/Zander/Desktop/test"
RESOURCE_FOLDER = "/Users/Zander/Desktop/test"
...
def main():
    ...
    matches = (
        [file.split('-')[0] for file in glob.glob("*.mp3")],
    ...
    context = { # Your variables for your template will go in this dictionary
        'audio_files': set([file+'-1.mp3' for file in matches]),
        'image_files': [
